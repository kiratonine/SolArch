...
beforeAll(() => {
  // jsdom 26 intentionally leaves scrolling unimplemented, while TanStack Router
  // invokes it after navigation. Browser behavior is covered by the real E2E;
  // unit tests only need navigation to complete without test-environment noise.
