...
export const en = {
  ...
  "files.open": "Open internally",
  "files.count": "files",
  "viewer.select": "Select a protected file to view it inside SolArch.",
  "viewer.loading": "Preparing protected view…",
  "viewer.close": "Close file",
  "viewer.retry": "Try again",
  "viewer.error": "This file could not be rendered safely.",
  "viewer.noExport": "Internal viewing only · export and external opening are disabled",
  "watermark.wallet": "Wallet",
  "watermark.license": "License",
  "watermark.archive": "Archive",
  ...
  "xlsx.previousRows": "Previous rows",
  "xlsx.nextRows": "Next rows",
  "xlsx.previousColumns": "Previous columns",
  "xlsx.nextColumns": "Next columns",
  "xlsx.sheet": "Sheet",
  ...
  "errors.unsupportedFile": "This protected file type is not supported.",
  "errors.rendererError": "The protected file is malformed or could not be rendered safely.",
  "errors.rendererLimit": "The protected file exceeds safe renderer limits.",
  "errors.rendererClosed": "This protected view is no longer authorized. Open the file again.",
...
export const ru: Record<MessageKey, string> = {
  ...
  "window.titlebar": "Окно приложения",
  ...
  "payment.backToPayment": "Вернуться к оплате",
  ...
  "files.open": "Открыть внутри Viewer",
  "files.count": "файлов",
  "viewer.select": "Выберите защищённый файл для просмотра внутри SolArch.",
  "viewer.loading": "Подготовка защищённого просмотра…",
  "viewer.close": "Закрыть файл",
  "viewer.retry": "Повторить",
  "viewer.error": "Файл не удалось безопасно отобразить.",
  "viewer.noExport": "Только внутренний просмотр · экспорт и внешнее открытие отключены",
  "watermark.wallet": "Кошелёк",
  "watermark.license": "Лицензия",
  "watermark.archive": "Архив",
  "pdf.previous": "Предыдущая страница",
  "pdf.next": "Следующая страница",
  "pdf.page": "Страница",
  "pdf.of": "из",
  "pdf.zoomIn": "Увеличить",
  "pdf.zoomOut": "Уменьшить",
  "pdf.fitPage": "По размеру страницы",
  "pdf.fitWidth": "По ширине",
  "image.fit": "Вписать изображение",
  "image.reset": "Сбросить масштаб",
  "xlsx.previousRows": "Предыдущие строки",
  "xlsx.nextRows": "Следующие строки",
  "xlsx.previousColumns": "Предыдущие столбцы",
  "xlsx.nextColumns": "Следующие столбцы",
  "xlsx.sheet": "Лист",
  ...
  "errors.unsupportedFile": "Этот тип защищённого файла не поддерживается.",
  "errors.rendererError": "Защищённый файл повреждён или не может быть безопасно отображён.",
  "errors.rendererLimit": "Защищённый файл превышает безопасные лимиты renderer.",
  "errors.rendererClosed": "Этот защищённый просмотр больше не авторизован. Откройте файл снова.",
